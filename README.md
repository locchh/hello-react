...
`xdg-open index.html` (Linux) or `open index.html` (MacOS)
...
- [expressjs.com](https://expressjs.com/) — Node.js backend framework, not React-specific but often used as the API server behind a React frontend
- [nodejs.org](https://nodejs.org/en) — the JavaScript runtime that powers npm, Vite, Next.js, and Express
